...
public class SelectManyExercises : LinqExercise
{
    ...
    public void Easy_01_FlattenTheMatrix()
    {
        ...
        IEnumerable<int> result = Data.Matrix.SelectMany(row => row); //!
    ...
    public void Easy_02_AllStudentsFromAllCohorts()
    {
        ...
        IEnumerable<Student> result = Data.Cohorts.SelectMany(c => c.Students); //!
    ...
    public void Easy_03_AllJuniorInstructorsWithDuplicates()
    {
        ...
        IEnumerable<Instructor> result = Data.Cohorts.SelectMany(c => c.JuniorInstructors); //!
    ...
    public void Medium_04_FlattenStringsIntoCharacters()
    {
        ...
        IEnumerable<char> result = Data.Words.SelectMany(w => w); //!
    ...
    public void Medium_05_ResultSelectorPairsParentWithChild()
    {
        ...
        IEnumerable<(string Cohort, string Student)> result = Data.Cohorts.SelectMany(c => c.Students, (c, s) => (c.Name, s.FirstName)); //!
    ...
    public void Medium_06_PrimaryPlusJuniorsPerCohort()
    {
        ...
        IEnumerable<Instructor> result = Data.Cohorts.SelectMany(c => c.JuniorInstructors.Prepend(c.PrimaryInstructor)); //!
    ...
    public void Medium_07_SelectManyWithIndex()
    {
        ...
        IEnumerable<int> result = Data.Matrix.SelectMany((row, i) => row.Select(v => v * i)); //!
    ...
    public void Hard_08_CartesianProduct()
    {
        ...
        IEnumerable<string> result = numbers.SelectMany(n => letters, (n, l) => $"{n}{l}"); //!
    ...
    public void Hard_09_SplitSentencesIntoWords()
    {
        ...
        IEnumerable<string> result = sentences.SelectMany(s => s.Split(' ')); //!
    ...
    public void Hard_10_FlattenThenFilter()
    {
        ...
        IEnumerable<(string Cohort, string Student)> result = Data.Cohorts.SelectMany(c => c.Students.Where(s => !s.Active), (c, s) => (c.Name, s.FirstName)); //!
