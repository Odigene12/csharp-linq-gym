...
public class GroupByExercises : LinqExercise
{
    ...
    public void Easy_02_NumbersByParity()
    {
        ...
        IEnumerable<IGrouping<bool, int>> result = TODO;
    ...
    public void Easy_03_WordsByLength()
    {
        ...
        IEnumerable<IGrouping<int, string>> result = TODO;
    ...
    public void Hard_08_CompositeKey()
    {
        ...
        IEnumerable<IGrouping<(int Year, int CourseId), Enrollment>> result = TODO;
