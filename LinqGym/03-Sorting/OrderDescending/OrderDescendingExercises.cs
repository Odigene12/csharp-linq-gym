...
public class OrderDescendingExercises : LinqExercise
{
    ...
    public void Easy_01_NumbersDescending()
    {
        ...
        IEnumerable<int> result = Data.Numbers.OrderDescending(); //!
    ...
    public void Easy_02_WordsOrdinalDescending()
    {
        ...
        IEnumerable<string> result = Data.Words.OrderDescending(StringComparer.Ordinal); //!
    ...
    public void Easy_03_TemperaturesHottestFirst()
    {
        ...
        IEnumerable<double> result = Data.Temperatures.OrderDescending(); //!
    ...
    public void Medium_04_TopThreePrices()
    {
        ...
        IEnumerable<decimal> result = Data.Prices.OrderDescending().Take(3); //!
    ...
    public void Medium_05_CaseInsensitiveDescending()
    {
        ...
        IEnumerable<string> result = Data.Words.OrderDescending(StringComparer.OrdinalIgnoreCase); //!
    ...
    public void Hard_06_BirthdaysLatestFirst()
    {
        ...
        IEnumerable<DateOnly> result = Data.Students.Select(s => s.Birthday).OrderDescending(); //!
    ...
    public void Hard_07_ThirdLargestDistinctNumber()
    {
        ...
        int result = Data.Numbers.Distinct().OrderDescending().ElementAt(2); //!
