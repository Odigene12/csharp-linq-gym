...
public class OrderByExercises : LinqExercise
{
    ...
    public void Easy_01_NumbersAscending()
    {
        ...
        IEnumerable<int> result = Data.Numbers.OrderBy(n => n); //!
    ...
    public void Easy_02_StudentsOldestFirst()
    {
        ...
        IEnumerable<Student> result = Data.Students.OrderBy(s => s.Birthday); //!
    ...
    public void Easy_03_WordsByLengthIsStable()
    {
        ...
        IEnumerable<string> result = Data.Words.OrderBy(w => w.Length); //!
    ...
    public void Medium_04_OrdinalStringOrdering()
    {
        ...
        IEnumerable<string> result = Data.Words.OrderBy(w => w, StringComparer.Ordinal); //!
    ...
    public void Medium_05_CaseInsensitiveOrdering()
    {
        ...
        IEnumerable<string> result = Data.Words.OrderBy(w => w, StringComparer.OrdinalIgnoreCase); //!
    ...
    public void Medium_06_OrderByComputedKey()
    {
        ...
        IEnumerable<Student> result = Data.Students.OrderBy(s => s.Age); //!
    ...
    public void Medium_07_OrderByBoolean()
    {
        ...
        IEnumerable<Cohort> result = Data.Cohorts.OrderBy(c => c.FullTime); //!
    ...
    public void Hard_08_OddsFirstThenEvensKeepingOrder()
    {
        ...
        IEnumerable<int> result = Data.Numbers.OrderBy(n => n % 2 == 0); //!
    ...
    public void Hard_09_CustomPriorityOrder()
    {
        ...
        IEnumerable<Course> result = Data.Courses.OrderBy(c => priority.IndexOf(c.Category)); //!
