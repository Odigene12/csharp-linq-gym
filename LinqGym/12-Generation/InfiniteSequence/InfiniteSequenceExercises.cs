...
public class InfiniteSequenceExercises : LinqExercise
{
    ...
    public void Easy_01_FirstFiveNaturals()
    {
        ...
        IEnumerable<int> result = Enumerable.InfiniteSequence(1, 1).Take(5); //!
    ...
    {
        // Task: 0, 2, 4, 6.
        IEnumerable<int> result = Enumerable.InfiniteSequence(0, 2).Take(4); //!
    ...
    public void Easy_03_CountingDownForever()
    {
        ...
        IEnumerable<int> result = Enumerable.InfiniteSequence(10, -1).Take(3); //!
    ...
    public void Medium_04_StopWithTakeWhile()
    {
        ...
        IEnumerable<int> result = Enumerable.InfiniteSequence(1, 1).TakeWhile(n => n * n < 50); //!
    ...
    public void Medium_05_SkipIntoAnInfiniteSequence()
    {
        ...
        int result = Enumerable.InfiniteSequence(1, 1).Skip(100).First(); //!
    ...
    public void Hard_06_NumberWordsWithZip()
    {
        ...
        IEnumerable<string> result = Enumerable.InfiniteSequence(1, 1).Zip(Data.Words, (i, w) => $"{i}. {w}"); //!
    ...
    public void Hard_07_FirstSquareAboveOneThousand()
    {
        ...
        int result = Enumerable.InfiniteSequence(1, 1).First(n => n * n > 1000); //!
