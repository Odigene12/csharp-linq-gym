...
public class RightJoinExercises : LinqExercise
{
    ...
    public void Easy_01_EveryCourseAppears()
    {
        ...
        IEnumerable<(int? EnrollmentId, string Code)> result = TODO;
    ...
    public void Easy_02_EveryStudentAppears()
    {
        ...
        IEnumerable<(Enrollment? Enrollment, Student Student)> result = TODO;
    ...
    public void Medium_05_RightJoinIsASwappedLeftJoin()
    {
        ...
        IEnumerable<(string, int?)> left = TODO;
        IEnumerable<(string, int?)> right = TODO;
    ...
    public void Hard_06_CoursesPerInstructorIncludingZero()
    {
        ...
        IEnumerable<(string Name, int Courses)> result = TODO;
