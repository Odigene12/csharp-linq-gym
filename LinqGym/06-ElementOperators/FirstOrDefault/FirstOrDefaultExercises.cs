...
public class FirstOrDefaultExercises : LinqExercise
{
    ...
    public void Easy_01_NoMatchGivesZeroForInts()
    {
        ...
        int result = Data.Numbers.FirstOrDefault(n => n > 100); //!
    ...
    public void Easy_02_NoMatchGivesNullForClasses()
    {
        ...
        Student? result = Data.Students.FirstOrDefault(s => s.FirstName == "Zelda"); //!
    ...
    public void Easy_03_EmptySequenceGivesDefault()
    {
        ...
        int result = Data.Empty.FirstOrDefault(); //!
    ...
    public void Medium_04_ExplicitDefaultValue()
    {
        ...
        int result = Data.Numbers.FirstOrDefault(n => n > 100, -1); //!
    ...
    public void Medium_05_MatchIsReturnedNormally()
    {
        ...
        Student? result = Data.Students.FirstOrDefault(s => s.City == "Knoxville"); //!
    ...
    public void Medium_06_ZeroIsAmbiguousForValueTypes()
    {
        ...
        int? result = nums.Cast<int?>().FirstOrDefault(n => n > 5); //!
    ...
    public void Medium_07_NullConditionalAfterFirstOrDefault()
    {
        ...
        string? result = Data.Students.FirstOrDefault(s => s.City == "Paris")?.FirstName; //!
    ...
    public void Hard_08_StudentWithNoEnrollments()
    {
        ...
        Enrollment? result = Data.Enrollments.FirstOrDefault(e => e.StudentId == 12); //!
    ...
    public void Hard_09_HighestGradedEnrollment()
    {
        ...
        Enrollment? result = Data.Enrollments.OrderByDescending(e => e.Grade).FirstOrDefault(); //!
    ...
    public void Hard_10_FallbackObject()
    {
        ...
        Student result = Data.Students.FirstOrDefault(s => s.City == "Paris", Data.Student(1)); //!
